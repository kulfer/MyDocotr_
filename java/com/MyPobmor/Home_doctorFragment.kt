 ...
 * Use the [Home_doctorFragment.newInstance] factory method to
 * create an instance of this fragment
 */
class Home_doctorFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (currentUserUid != null) {
            ...
            mDbRef.child(currentUserUid).child("personal_data").addListenerForSingleValueEvent(object :
                ValueEventListener {
